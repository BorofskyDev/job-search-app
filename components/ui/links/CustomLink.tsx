...
export default function CustomLink({
  ...
  const baseClasses = cn(
    'group relative inline-flex items-center gap-2 cursor-pointer font-bold text-xl text-indigo-800 transition-colors duration-200 hover:text-indigo-950 pb-2 pt-1',
    className
  )
